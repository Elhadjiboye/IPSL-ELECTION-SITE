              ...
              <div class='col-sm-6'>
                <div class='box box-solid'>
                  <div class='box-header with-border'>
                    <h4 class='box-title'><b>".$row['type_election']."</b></h4>
                  </div>
                  <div class='box-body'>
                    <div class='chart'>
                      <canvas id='".slugify($row['type_election'])."' style='height:200px'></canvas>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <?php
    ...
    while($row = $query->fetch_assoc()){
      ...
      while($crow = $cquery->fetch_assoc()){
        array_push($carray, $crow['nom_candidat']);
      ...
      <script>
      $(function(){
        var rowid = '<?php echo $row['id_election']; ?>';
        var description = '<?php echo slugify($row['type_election']); ?>';
